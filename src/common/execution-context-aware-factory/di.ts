...
export const CLASS_FACTORY: ServiceIdentifier<ClassForFactoryServiceFactory> =
  Symbol.for("CLASS_FACTORY");

appContainer
  .bind<ClassForFactoryServiceFactory>(CLASS_FACTORY)
  .toDynamicValue(async (context: Context) => {
